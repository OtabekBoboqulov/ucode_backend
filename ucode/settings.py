...
BASE_URL = 'https://web-production-d4808.up.railway.app'
...
# DEBUG = True
ALLOWED_HOSTS = ['web-production-d4808.up.railway.app', '0.0.0.0', 'localhost', '127.0.0.1']
